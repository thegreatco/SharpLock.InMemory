...
namespace SharpLock.InMemory
{
        ...
        where TLockableObject : class, ISharpLockable<string>
    {
        ...
        public SharpLockInMemoryStringIdDataStore(IEnumerable<TLockableObject> rawStore, ISharpLockLogger sharpLockLogger,
            TimeSpan lockTime)
        {
            _baseDataStore =
                new SharpLockInMemoryStringIdDataStore<TLockableObject, TLockableObject>(rawStore, sharpLockLogger, lockTime);
        }
